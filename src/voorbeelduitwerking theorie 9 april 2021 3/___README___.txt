...
Een voorbeeldje: Vraag 1(c) over het loggen van de legale/illegale waardes bij van Beschermd. Deze is opgedeeld in 3 delen.
...
Denk hierbij bv. aan de functie massa uit Electron. Die functie is abstract, dus moet iig in Quark geimplementeerd worden. Maar omdat ie een String moet returnen, 
zul je 'm in Neutronium moeten overschrijven.
...
De overige 3 punten krijg je *alleen* als je (1) twee construtors hebt in Neutronium, en (2) in 1 van die 2 constructors het keyword this(...) hebt gebruikt ipv super(..).
